-- OICAR Database Schema Update
-- This script will drop old tables and create the new marketplace schema
...
-- =============================================
-- STEP 2: Create new updated schema
-- =============================================
...
CREATE INDEX IX_User_RequestedAnonymization ON [User](RequestedAnonymization) WHERE RequestedAnonymization = 1;
CREATE INDEX IX_User_AnonymizationRequestDate ON [User](AnonymizationRequestDate) WHERE AnonymizationRequestDate IS NOT NULL;
